...
const TOKEN_NAME = 'MyCrowdSaleB'

const TOKEN_SYMBOL = 'MBB'

const TOKEN_DECIMAL_MULTIPLIER = 100 * 10^6

const TOKEN_DECIMALS = 8

const TARGET_USER = 0x170143c54ba2ad3cc65c90ea7305d4dfb96124e9

const PAUSED = 0

const TOKEN_DECIMALS_UINT8 = 8

const START_TIME = 1609535280
