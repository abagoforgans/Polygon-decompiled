...
function approve(address arg1, uint256 arg2) {
    ...
    if ownerOf[arg2] != msg.sender:
        require stor10[stor7[arg2]][address(msg.sender)]
    approved[arg2] = arg1
...
function sub_a4462eec(?) {
    ...
    stor12[stor23] = tokenOfOwnerByIndex[address(msg.sender)]
    emit Transfer(0, msg.sender, sub_c3710f25);
    stor14[stor23] = tokenByIndex.length
    tokenByIndex.length++
...
function mintWithTokenURI(address arg1, uint256 arg2, string arg3) {
    ...
    tokenByIndex[tokenByIndex.length].field_0 = arg2
    require ownerOf[arg2]
    uint256(stor17[arg2][]) = Array(len=arg3.length, data=arg3[all])
    return 1
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if ownerOf[arg3] != msg.sender:
        ...
        if approved[arg3] != msg.sender:
            require stor10[stor7[arg3]][address(msg.sender)]
    require arg2
    require ownerOf[arg3]
...
function sub_e8ff280e(?) {
    ...
    require 1 <= tokenOfOwnerByIndex[address(arg1)]
    require tokenOfOwnerByIndex[address(arg1)] - 1 < tokenOfOwnerByIndex[address(arg1)]
    require stor12[arg2] < tokenOfOwnerByIndex[address(arg1)]
    tokenOfOwnerByIndex[address(arg1)][stor12[arg2]] = tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]]
    tokenOfOwnerByIndex[address(arg1)]--
    if tokenOfOwnerByIndex[address(arg1)] > tokenOfOwnerByIndex[address(arg1)] - 1:
        idx = tokenOfOwnerByIndex[address(arg1)] - 1
        while tokenOfOwnerByIndex[address(arg1)] > idx:
            ...
            continue 
    stor12[arg2] = 0
    stor12[stor11[address(arg1)][stor11[address(arg1)]]] = stor12[arg2]
    emit Transfer(arg1, 0, arg2);
    require 1 <= tokenByIndex.length
    require tokenByIndex.length - 1 < tokenByIndex.length
    require stor14[arg2] < tokenByIndex.length
    tokenByIndex[stor14[arg2]].field_0 = tokenByIndex[tokenByIndex.length].field_0
    require tokenByIndex.length - 1 < tokenByIndex.length
    ...
    if tokenByIndex.length > tokenByIndex.length - 1:
        ...
        while tokenByIndex.length > idx:
            ...
            continue 
    stor14[arg2] = 0
    stor14[stor13[stor13.length].field_0] = stor14[arg2]
    if Mask(255, 1, (256 * not bool(stor17[arg2])) - 1 and uint256(stor17[arg2])):
        uint256(stor17[arg2]) = 0
        if 31 < stor17[arg2].length:
            idx = 0
            while stor17[arg2].length + 31 / 32 > idx:
                uint256(stor17[arg2][idx]) = 0
                idx = idx + 1
                continue 
}
...
function tokenURI(uint256 arg1) {
    ...
    if tokenURIPrefix.length + 32:
        mem[ceil32(tokenURIPrefix.length) + 160 len 32 * tokenURIPrefix.length + 32] = code.data[16678 len 32 * tokenURIPrefix.length + 32]
    s = 0
    idx = 0
