...
function sub_8dc83771(?) payable {
    ...
    while ceil32(stor1[arg1][1].length) + stor1[arg1][2].length + 128 > idx:
        ...
        s = s + 1
        continue 
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 160] = 64
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 224] = stor1[arg1][1].length
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 256 len ceil32(stor1[arg1][1].length)] = mem[128 len ceil32(stor1[arg1][1].length)]
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 192] = stor1[arg1][1].length + 96
    mem[stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 256] = stor1[arg1][2].length
    if stor1[arg1][2].length:
        mem[stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 288] = mem[ceil32(stor1[arg1][1].length) + 160]
        mem[stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 320 len floor32(stor1[arg1][2].length - 1)] = mem[ceil32(stor1[arg1][1].length) + 192 len floor32(stor1[arg1][2].length - 1)]
    if not stor1[arg1][2].length % 32:
        return Array(len=stor1[arg1][1].length, data=mem[128 len ceil32(stor1[arg1][1].length)], mem[(2 * ceil32(stor1[arg1][1].length)) + ceil32(stor1[arg1][2].length) + 256 len stor1[arg1][2].length + stor1[arg1][1].length + -ceil32(stor1[arg1][1].length) + 32]), 
               stor1[arg1][1].length + 96
    mem[floor32(stor1[arg1][2].length) + stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 288] = mem[floor32(stor1[arg1][2].length) + stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + -stor1[arg1][2].length % 32 + 320 len stor1[arg1][2].length % 32]
    return Array(len=stor1[arg1][1].length, data=mem[128 len ceil32(stor1[arg1][1].length)], mem[(2 * ceil32(stor1[arg1][1].length)) + ceil32(stor1[arg1][2].length) + 256 len floor32(stor1[arg1][2].length) + stor1[arg1][1].length + -ceil32(stor1[arg1][1].length) + 64]), 
           stor1[arg1][1].length + 96
}
