...
function replaceBeneficiary(address arg1) payable {
    require calldata.size - 4 >= 32
...
function sub_ee8e6b65(?) payable {
    ...
    if block.timestamp < cliff:
        ...
        if arg2 > -released[address(arg1)]:
            revert with 0, 32, 39, 0x7376616c75652069732067726561746572207468616e20756e72656c656173656420616d6f756e, mem[267 len 25]
        if arg2 + released[address(arg1)] < released[address(arg1)]:
            revert with 0, 'SafeMath: addition overflow'
        released[address(arg1)] += arg2
            ...
            if stor7[address(arg1)]:
                ...
                if not released[address(arg1)] + ext_call.return_data[0]:
                    ...
                    if (0 / duration) - released[address(arg1)] <= 0:
                        revert with 0, 'TokenVesting: no tokens are due'
                    if arg2 > (0 / duration) - released[address(arg1)]:
                        revert with 0, 32, 39, 0x7376616c75652069732067726561746572207468616e20756e72656c656173656420616d6f756e, mem[395 len 25]
                else:
                    if (released[address(arg1)] * block.timestamp) + (ext_call.return_data[0] * block.timestamp) - (released[address(arg1)] * start) - (ext_call.return_data[0] * start) / released[address(arg1)] + ext_call.return_data[0] != block.timestamp - start:
                        revert with 0, 32, 33, 0x74536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not duration:
                    ...
                    if ((released[address(arg1)] * block.timestamp) + (ext_call.return_data[0] * block.timestamp) - (released[address(arg1)] * start) - (ext_call.return_data[0] * start) / duration) - released[address(arg1)] <= 0:
                        revert with 0, 'TokenVesting: no tokens are due'
                    if arg2 > ((released[address(arg1)] * block.timestamp) + (ext_call.return_data[0] * block.timestamp) - (released[address(arg1)] * start) - (ext_call.return_data[0] * start) / duration) - released[address(arg1)]:
                        revert with 0, 32, 39, 0x7376616c75652069732067726561746572207468616e20756e72656c656173656420616d6f756e, mem[395 len 25]
                if arg2 + released[address(arg1)] < released[address(arg1)]:
                    revert with 0, 'SafeMath: addition overflow'
                released[address(arg1)] += arg2
                ...
                if not ext_code.hash(arg1):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, arg2) >> 32
                call arg1 with:
                   funct uint32(stor1)
                     gas gas_remaining wei
...
function revoke(address arg1) payable {
    ...
    if block.timestamp < cliff:
        ...
        if not ext_code.hash(arg1):
            revert with 0, 'SafeERC20: call to non-contract'
        mem[324 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor0), uint32(stor0), Mask(224, 32, ext_call.return_data[0] + released[address(arg1)]) >> 32
        call arg1 with:
           funct uint32(stor0)
             gas gas_remaining wei
        ...
        if block.timestamp >= duration + start:
            ...
            if not ext_code.hash(arg1):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[324 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor0), uint32(stor0), 0
            call arg1 with:
               funct uint32(stor0)
                 gas gas_remaining wei
                args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor0), uint32(stor0), 0) << 256, mem[388 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 'SafeERC20: low-level call failed'
            mem[356 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if stor7[address(arg1)]:
                ...
                if not released[address(arg1)] + ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(arg1):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor0), uint32(stor0), Mask(224, 32, ext_call.return_data[0] - (0 / duration) + released[address(arg1)]) >> 32
                    call arg1 with:
                       funct uint32(stor0)
                         gas gas_remaining wei
                    ...
                    if not ext_code.hash(arg1):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor0), uint32(stor0), Mask(224, 32, ext_call.return_data[0] - ((released[address(arg1)] * block.timestamp) + (ext_call.return_data[0] * block.timestamp) - (released[address(arg1)] * start) - (ext_call.return_data[0] * start) / duration) + released[address(arg1)]) >> 32
                    call arg1 with:
                       funct uint32(stor0)
                         gas gas_remaining wei
...
function release(address arg1) payable {
    ...
    if block.timestamp < cliff:
        ...
        if not ext_code.hash(arg1):
            revert with 0, 'SafeERC20: call to non-contract'
        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, -released[address(arg1)]) >> 32
        call arg1 with:
           funct uint32(stor1)
             gas gas_remaining wei
        ...
        if block.timestamp >= duration + start:
            ...
            if stor7[address(arg1)]:
                ...
                if not released[address(arg1)] + ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(arg1):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, (0 / duration) - released[address(arg1)]) >> 32
                    call arg1 with:
                       funct uint32(stor1)
                         gas gas_remaining wei
                    ...
                    if not ext_code.hash(arg1):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[388 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, ((released[address(arg1)] * block.timestamp) + (ext_call.return_data[0] * block.timestamp) - (released[address(arg1)] * start) - (ext_call.return_data[0] * start) / duration) - released[address(arg1)]) >> 32
                    call arg1 with:
                       funct uint32(stor1)
                         gas gas_remaining wei
