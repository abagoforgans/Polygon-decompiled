...
function sub_e453d0f3(?) payable {
    ...
    if (2 * arg2.length) - 2:
        mem[ceil32(arg2.length) + 192 len (2 * arg2.length) - 2] = code.data[4111 len (2 * arg2.length) - 2]
    idx = 0
...
function sub_0c0d286d(?) payable {
    ...
    if (2 * arg1.length) - 2:
        mem[ceil32(arg1.length) + 192 len (2 * arg1.length) - 2] = code.data[4111 len (2 * arg1.length) - 2]
    idx = 0
