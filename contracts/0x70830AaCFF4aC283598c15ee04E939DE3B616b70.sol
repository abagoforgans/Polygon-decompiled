...
function getBetsCountAndValue() payable {
    ...
    while idx < bets.length:
        ...
        continue 
    return bets.length, stor[(2 * stor8.length) + _6 + 1] * bets.length
}
    ...
    while uint8(idx) < bets.length:
        ...
        if arg1 == uint8(bets[2 * uint8(idx)].field_176):
            if not uint8(bets[2 * uint8(idx)].field_160):
                ...
                mem[32] = sha3(uint8(bets[2 * uint8(idx)].field_0), sha3(uint8(bets[2 * uint8(idx)].field_0), 7))
                if not currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]:
                    ...
                    if 36 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] / currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] != 36:
                        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                    require uint8(bets[2 * uint8(idx)].field_160) < 6
                    if 36 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] > mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96]:
                        require uint8(bets[2 * uint8(idx)].field_160) < 6
                        mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96] = 36 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]
            else:
                if uint8(bets[2 * uint8(idx)].field_160) == 1:
                    ...
                    if not currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]:
                        ...
                        if 2 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] / currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] != 2:
                            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                        require uint8(bets[2 * uint8(idx)].field_160) < 6
                        if 2 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] > mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96]:
                            require uint8(bets[2 * uint8(idx)].field_160) < 6
                            mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96] = 2 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]
                else:
                    if uint8(bets[2 * uint8(idx)].field_160) == 2:
                        ...
                        if uint8(bets[2 * uint8(idx)].field_160) == 3:
                            ...
                            if not currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]:
                                ...
                                if 3 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] / currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] != 3:
                                    revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                                require uint8(bets[2 * uint8(idx)].field_160) < 6
                                if 3 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)] > mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96]:
                                    require uint8(bets[2 * uint8(idx)].field_160) < 6
                                    mem[(32 * uint8(uint8(bets[2 * uint8(idx)].field_160))) + 96] = 3 * currentBets[uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)][uint8(stor8[2 * uint8(idx)].field_0)]
        idx = idx + 1
        continue 
    idx = 0
    s = 0
