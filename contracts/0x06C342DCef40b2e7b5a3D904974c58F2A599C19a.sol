...
function mint(address arg1, uint256 arg2, string arg3) payable {
    ...
    if arg3.length:
        stor8[arg2][] = Array(len=arg3.length, data=arg3[all])
    else:
        stor8[arg2] = 0
        idx = 0
