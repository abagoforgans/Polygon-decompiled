...
const pairCodeHash = sha3(code.data[1860 len 9344])
...
function createPair(address arg1, address arg2) payable {
    ...
    if arg1 < arg2:
        ...
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1860 len 261], 40, address(arg1), uint64(arg2) << 96, code.data[2205 len 8999]
        ...
        create2 contract with 0 wei
                        salt: sha3(arg2, arg1)
                        code: code.data[1860 len 261], 40, address(arg2), uint64(arg1) << 96, code.data[2205 len 8999]
        require ext_code.size(address(create2.new_address))
        call address(create2.new_address).initialize(address arg1, address arg2) with:
             gas gas_remaining wei
