...
function sub_79614b2e(?) payable {
    ...
    while stor1[arg1][1].length + 96 > idx:
        ...
        s = s + 1
        continue 
    return arg1, Array(len=stor1[arg1][1].length, data=mem[128 len stor1[arg1][1].length]), stor2[arg1]
}
...
function showWinner() payable {
    ...
    while idx <= sub_4b1c4c29:
        ...
        mem[_22] = stor1[idx][1].length
        mem[0] = sha3(idx, 1) + 1
        mem[_22 + 32] = stor1[idx][1].field_0
        t = _22 + 32
        u = sha3(mem[0])
        while _22 + stor1[t][1].length > t:
            mem[t + 32] = stor1[u].field_0
            t = t + 32
            u = u + 1
            continue 
        mem[0] = _22 + floor32(stor1[t][1].length - 1) + 32
        mem[32] = 2
        t = _22 + floor32(stor1[t][1].length - 1) + 33
        u = _22
...
function sub_8dc83771(?) payable {
    ...
    while stor1[arg1][2].length + 96 > idx:
        ...
        s = s + 1
        continue 
    mem[64] = ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 160
    mem[ceil32(stor1[arg1][2].length) + 128] = stor1[arg1][1].length
    mem[0] = sha3(arg1, 1) + 1
    mem[ceil32(stor1[arg1][2].length) + 160] = stor1[arg1][1].field_0
    idx = ceil32(stor1[arg1][2].length) + 160
    s = 0
    while ceil32(stor1[arg1][2].length) + stor1[arg1][1].length + 128 > idx:
        mem[idx + 32] = stor1[arg1][s + 1].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 160] = 64
    mem[ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 224] = stor1[arg1][2].length
    mem[ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 256 len ceil32(stor1[arg1][2].length)] = mem[128 len ceil32(stor1[arg1][2].length)]
    mem[ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 192] = stor1[arg1][2].length + 96
    mem[stor1[arg1][2].length + ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 256] = stor1[arg1][1].length
    if stor1[arg1][1].length:
        mem[stor1[arg1][2].length + ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 288] = mem[ceil32(stor1[arg1][2].length) + 160]
        mem[stor1[arg1][2].length + ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 320 len floor32(stor1[arg1][1].length - 1)] = mem[ceil32(stor1[arg1][2].length) + 192 len floor32(stor1[arg1][1].length - 1)]
    if not stor1[arg1][1].length % 32:
        return Array(len=stor1[arg1][2].length, data=mem[128 len ceil32(stor1[arg1][2].length)], mem[(2 * ceil32(stor1[arg1][2].length)) + ceil32(stor1[arg1][1].length) + 256 len stor1[arg1][1].length + stor1[arg1][2].length + -ceil32(stor1[arg1][2].length) + 32]), 
               stor1[arg1][2].length + 96
    mem[floor32(stor1[arg1][1].length) + stor1[arg1][2].length + ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + 288] = mem[floor32(stor1[arg1][1].length) + stor1[arg1][2].length + ceil32(stor1[arg1][2].length) + ceil32(stor1[arg1][1].length) + -stor1[arg1][1].length % 32 + 320 len stor1[arg1][1].length % 32]
    return Array(len=stor1[arg1][2].length, data=mem[128 len ceil32(stor1[arg1][2].length)], mem[(2 * ceil32(stor1[arg1][2].length)) + ceil32(stor1[arg1][1].length) + 256 len floor32(stor1[arg1][1].length) + stor1[arg1][2].length + -ceil32(stor1[arg1][2].length) + 64]), 
           stor1[arg1][2].length + 96
}
