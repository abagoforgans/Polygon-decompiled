...
function sub_8dc83771(?) payable {
    ...
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 192] = 96
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 256] = stor1[arg1][1].length
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 288 len ceil32(stor1[arg1][1].length)] = mem[128 len ceil32(stor1[arg1][1].length)]
    mem[ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 224] = stor1[arg1][1].length + 128
    mem[stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 288] = stor1[arg1][2].length
    mem[stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 320 len ceil32(stor1[arg1][2].length)] = mem[ceil32(stor1[arg1][1].length) + 160 len ceil32(stor1[arg1][2].length)]
    if not stor1[arg1][2].length % 32:
        return stor1[arg1].field_0, 
               Array(len=stor1[arg1][1].length, data=mem[128 len ceil32(stor1[arg1][1].length)], mem[(2 * ceil32(stor1[arg1][1].length)) + ceil32(stor1[arg1][2].length) + 288 len stor1[arg1][2].length + stor1[arg1][1].length + -ceil32(stor1[arg1][1].length) + 32]),
               stor1[arg1][1].length + 128
    mem[floor32(stor1[arg1][2].length) + stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + 320] = mem[floor32(stor1[arg1][2].length) + stor1[arg1][1].length + ceil32(stor1[arg1][1].length) + ceil32(stor1[arg1][2].length) + -stor1[arg1][2].length % 32 + 352 len stor1[arg1][2].length % 32]
    return stor1[arg1].field_0, 
           Array(len=stor1[arg1][1].length, data=mem[128 len ceil32(stor1[arg1][1].length)], mem[(2 * ceil32(stor1[arg1][1].length)) + ceil32(stor1[arg1][2].length) + 288 len floor32(stor1[arg1][2].length) + stor1[arg1][1].length + -ceil32(stor1[arg1][1].length) + 64]),
           stor1[arg1][1].length + 128
}
